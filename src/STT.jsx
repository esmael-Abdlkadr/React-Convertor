    ...
    <div>
      ...
      <section className={"bg-[#fff]"}>
        ...
        <div className={"grid grid-cols-2 gap-x-16 gap-y-24"}>
          ...
          <div>
            <h3
              className={"text-2xl text-[#475569] text-center  font-semibold"}
            >
            ...
            >
              <span>
                ...
                few lines of code. With support for multiple languages,
                including Amharic,
              </span>
              <span>
                React SpeakUp is a versatile tool that can be used in a wide
                range of applications. Whether you're building a
                voice-controlled app, a transcription tool, or anything in
                between, React SpeakUp has you covered. So why wait? Install
                React SpeakUp today and start converting speech to text in no
                time!
              </span>
              <span>
